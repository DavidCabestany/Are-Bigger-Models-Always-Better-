...
for i in range(21):
    TextsDF_Base.append(pd.read_csv('<Your_Local_Path>/bert-base-uncased_Fold' + str(i) + '.csv'))
    TextsDF_Distil.append(pd.read_csv('<Your_Local_Path>/distilbert-base-uncased_Fold' + str(i) + '.csv'))
