...
for i in range(21):
  TextsDF_Base.append(pd.read_csv('/content/drive/MyDrive/Zero_shot_folds_10k/bert-base-uncased_Fold'+str(i)+'.csv'))
  TextsDF_Distil.append(pd.read_csv('/content/drive/MyDrive/Zero_shot_folds_10k/distilbert-base-uncased_Fold'+str(i)+'.csv'))
